...
(function($) {
    ...
    $(document).on('ready', function() {
        ...
        $(document).ready(function() {
            // Function to initialize counting with plus sign on complete
            ...
            // Initial call to countTo
            initCountTo();
        
            // Trigger counting when elements appear
...
$(document).ready(function() {
    ...
    var iti = window.intlTelInput(input, {
     ...
     input.addEventListener('keydown', function(event) {
        // Allow: backspace, delete, tab, escape, enter, period, comma, dash
